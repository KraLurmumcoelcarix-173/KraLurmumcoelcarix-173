#!/usr/bin/env python3
"""
make_doro_snow.py - wrap a static image in a light-blue + animated-snow panel
for a GitHub profile README (snow falls *over* the picture).

    python3 make_doro_snow.py            # uses dorothy.png -> doro_snow.svg
    python3 make_doro_snow.py pic.png out.svg
...
src = sys.argv[1] if len(sys.argv) > 1 else "dorothy.png"
out = sys.argv[2] if len(sys.argv) > 2 else "doro_snow.svg"
